...
import PathMarquee from "./PathMarquee.vue";
...
<template>
  ...
  >
    <PathMarquee
      ...
      :base-velocity="props.baseVelocity"
      :slowdown-on-hover="props.slowdownOnHover"
    ...
    >
      <div
        ...
        :key="image"
        class="h-full w-14 transition-transform duration-300 ease-in-out hover:scale-150"
      >
        <img
          :src="image"
          :alt="`Example ${index + 1}`"
